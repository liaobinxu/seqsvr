...
void showUsage( const char * program )
{
    ...
    AllocsvrTool::Name2Func_t * name2func = AllocsvrTool::GetName2Func();

    for( int i = 0; ; i++ ) {
        AllocsvrTool::Name2Func_t * iter = &( name2func[i] );
...
int main( int argc, char * argv[] )
{
    ...
    if( NULL != config ) AllocsvrClient::Init( config );

    AllocsvrTool::Name2Func_t * target = NULL;
    ...
    AllocsvrTool::ToolFunc_t targefunc = target->func;

    AllocsvrToolImpl tool;
